			...
			<nav className='container mx-auto flex items-center justify-between py-4 px-3 '>
				...
				<div className='flex items-center space-x-4'>
					...
					<button
						...
						<IoCartOutline className='h-6.5 w-6.5 text-gray-700 cursor-pointer' />
						{cartItemCount > 0 && (<span className='absolute -top-1 bg-[#ea2e02] text-white text-xs rounded-full px-2 py-0.5'>{cartItemCount}</span>)}
					</button>
