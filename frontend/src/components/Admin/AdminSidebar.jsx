...
const AdminSidebar = ({toggleSidebar}) => {
	...
	return (
		<div className='p-6'>
			...
			<Link to="/admin" onClick={toggleSidebar}><h2 className="text-xl font-medium mb-6 text-center">Admin Dashboard</h2></Link>
			...
			<nav className='flex flex-col space-y-2 '>
				...
				<NavLink to="/collections/all" className={({ isActive }) => isActive ? "bg-gray-700 text-white py-3 px-4 rounded flex items-center space-x-2" : "text-gray-300 hover:bg-gray-700 hover:text-white py-3 px-4 rounded flex items-center space-x-2"}>
					<FaStore />
					<span>Shop</span>
				</NavLink>
			</nav>
